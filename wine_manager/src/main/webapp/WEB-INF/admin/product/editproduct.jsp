                        ...
                        <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                                <li class="active"><a href="#description"><i class="icon nalika-edit"
                                                                             aria-hidden="true"></i> Edit Wine</a></li>
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               name="title"
                                                               value="<c:out value='${wine.getTitle()}' />"
                                                        />
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit"
                                                                                           aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control"
                                                               value="<c:out value='${wine.getQuantity()}' />"
                                                               name="quantity">
                                                    </div>
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit"
                                                                                           aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control"
                                                               value="<c:out value='${wine.getPrice()}' />"
                                                               name="price">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    ...
                                                    <button class="btn btn-ctl-bt waves-effect waves-light"><a
                                                            href="/wines" value="Discard">Discard</a>
                                                    </button>
