                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product List" href="listuser.jsp"><span class="mini-sub-pro">Product List</span></a></li>
                                <li><a title="Product Edit" href="edituser.jsp"><span class="mini-sub-pro">Product Edit</span></a></li>
